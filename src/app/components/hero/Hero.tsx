          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={buttonTap}
              >
                <Link href="https://diversosingressos.com.br/event/ec7114db-7351-43e5-9521-7592db374b33" target="_blank">
                  <span className="relative z-10 max-md:text-sm max-md:uppercase">Comprar Ingressos</span>
                </Link>
                <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
              </motion.button>
              <motion.button
                className="relative overflow-hidden group border-2  font-semibold py-4 px-8 rounded-full text-lg"
                style={{
              ...
              >
                <Link href="#sobre">
                  <span
                    ...
                    className="relative z-10 max-md:text-sm max-md:uppercase">Saiba Mais</span>
                </Link>
