        ...
        <div className="space-y-3">
          ...
          <div className="rounded-lg border-l-4 border-[#2f5d9b] bg-[#dceff8] p-4">
            ...
            <ul className="mt-3 space-y-2">
              <li><strong>PIX parcelado:</strong> 3x de R$250,00, com o primeiro pagamento até 20/08. A chave é <a href="mailto:eventos.enlair@gmail.com" className="break-all text-[#2f5d9b] hover:underline">eventos.enlair@gmail.com</a>.</li>
              <li><strong>PIX à vista:</strong> R$729,00, válido para pagamento até 20/08. O código copia e cola está disponível no card de pagamento.</li>
